...
connection.query(queryStr, function(err, data) {
    ...
    for (var i = 0; i < data.length; i++) {
       stockProduct = '';
       stockProduct += 'Item ID: ' + data[i].item_id + '  //  ';
       stockProduct += 'Product Name: ' + data[i].product_name + '  //  ';
       stockProduct += 'Department: ' + data[i].department_name + '  //  ';
       stockProduct += 'Price: $' + data[i].price + '  //  ';
       stockProduct += 'Quantity: ' + data[i].stock_quantity + '\n';
...
// runbamazondb will execute the main application logic
function runbamazondb() {
// console.log('___ENTER runbamazondb___');
